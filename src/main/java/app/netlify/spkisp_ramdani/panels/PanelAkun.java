...
public class PanelAkun extends javax.swing.JPanel {
    ...
    public PanelAkun() {
        this.fDef = new String[][]{
            {"ID Akun", "id_akun", "text", ""},
            {"Nama Pengguna", "nama_pengguna", "text", ""},
            {"Sandi", "sandi", "text", ""},
            {"Alamat", "alamat", "text", ""},
...
//                System.out.println();
            ...
            tbl.getColumnModel().getColumn(2).setCellRenderer(new PasswordCellRenderer());
        }
...
//            bUrutan.setText("Menaik");
    ...
    private void initComponents() {
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "ID", "Nama Pengguna", "Sandi", "Alamat", "Telepon", "Email"
            }
        ));
